...
let ErrorInterceptor = class ErrorInterceptor {
     ...
     */
    handleUnauthorized(request, next) {
        if (this.isRefreshingToken) {
            // If token refresh is in progress, we'll wait until it's refreshed
            return this.authenticationService.currentUser
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])((user) => user.token != null), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((user) => {
            ...
            Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((user) => {
                if (!!user.token) {
                    ...
                    return next.handle(this.addToken(request, user.token)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])((err2) => {
...
let JwtInterceptor = class JwtInterceptor {
    ...
    intercept(request, next) {
        ...
        const isApiUrl = request.url.startsWith(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl);
...
/* harmony import */ var _app_home_models__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @app/home/_models */ "./src/app/home/_models/index.ts");
/* harmony import */ var _model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./model */ "./src/app/admin/_models/model.ts");


class Post extends _model__WEBPACK_IMPORTED_MODULE_1__["Model"] {
    constructor(data) {
        super(data);
    }
    isPage() {
        return this.type && this.type === _app_home_models__WEBPACK_IMPORTED_MODULE_0__["Type"].Page;
    }
}
Post.ctorParameters = () => [
    { type: undefined }
...
/* harmony import */ var _model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./model */ "./src/app/admin/_models/model.ts");

class Setting extends _model__WEBPACK_IMPORTED_MODULE_0__["Model"] {
    constructor(data) {
        super(data);
    }
}
Setting.ctorParameters = () => [
    { type: undefined }
];
...
class Tag extends _model__WEBPACK_IMPORTED_MODULE_0__["Model"] {
    constructor(data) {
        super(data);
    }
}
...
/* harmony import */ var _model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./model */ "./src/app/admin/_models/model.ts");
/* harmony import */ var _role__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./role */ "./src/app/admin/_models/role.ts");
...
class User extends _model__WEBPACK_IMPORTED_MODULE_0__["Model"] {
    ...
    isSuperAdmin() {
        return this.role === _role__WEBPACK_IMPORTED_MODULE_1__["Role"].SuperAdmin;
    }
    isAdmin() {
        return this.role === _role__WEBPACK_IMPORTED_MODULE_1__["Role"].Admin;
    }
    isWriter() {
        return this.role === _role__WEBPACK_IMPORTED_MODULE_1__["Role"].Writer;
    }
}
User.ctorParameters = () => [
    { type: undefined }
...
let AuthenticationService = class AuthenticationService {
    ...
    me() {
        return this.http
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((res) => new _admin_models__WEBPACK_IMPORTED_MODULE_6__["User"](res)));
    }
    /**
    ...
    login(email, password) {
        return this.http
            .post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl}/auth/login`, { email, password })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((res) => new _admin_models__WEBPACK_IMPORTED_MODULE_6__["User"](res)))
            // Save the user data as a side effect.
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((user) => this.storeUserData(user)));
    }
    /**
    ...
    updateUserData() {
        ...
        this.me()
            ...
            const user = new _admin_models__WEBPACK_IMPORTED_MODULE_6__["User"](res);
            user.token = this.userToken;
            return user;
        }), 
        // Save the latest user data as a side effect.
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((user) => this.storeUserData(user)))
            .subscribe();
    ...
    refreshToken(expiredToken) {
        return this.http
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((res) => new _admin_models__WEBPACK_IMPORTED_MODULE_6__["User"](res)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((user) => this.storeUserData(user)));
    }
    /**
...
class CRUD {
    constructor(apiUrl, http, typeClass) {
        this.apiUrl = apiUrl;
        this.http = http;
    ...
    index() {
        return this.http.get(`${this.apiUrl}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((res) => {
            const newModels = [];
            res.forEach((val) => {
                newModels.push(new this.typeClass(val));
            });
            return newModels;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])((models) => {
    ...
    get(id) {
        return this.http
            .get(`${this.apiUrl}/${id}`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((res) => new this.typeClass(res)));
    }
    create(data) {
        return this.http
    ...
    update(id, data) {
        return this.http.put(`${this.apiUrl}/${id}`, data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((res) => new this.typeClass(res)));
    }
    delete(id) {
    ...
    find(id) {
        return new Promise((resolve, reject) => {
            ...
            if (!existingModel) {
                this.get(id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(err => {
                    reject();
...
let PostsService = class PostsService extends _crud__WEBPACK_IMPORTED_MODULE_6__["CRUD"] {
    constructor(httpClient) {
        super(`${_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl}/post`, httpClient, _app_admin_models__WEBPACK_IMPORTED_MODULE_5__["Post"]);
        this.httpClient = httpClient;
        this.models$ = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"]([]);
    }
    getPage(id) {
        return this.httpClient
            .get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl}/post/page/${id}`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((res) => new _app_admin_models__WEBPACK_IMPORTED_MODULE_5__["Post"](res)));
    }
    update(id = null, data) {
        return this.httpClient
    ...
    indexPaginated(type, published, currentPage, tableSize) {
        const params = {};
        params.type = type;
...
let TagsService = class TagsService extends _crud__WEBPACK_IMPORTED_MODULE_6__["CRUD"] {
    constructor(httpClient) {
        super(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/tag`, httpClient, _models__WEBPACK_IMPORTED_MODULE_5__["Tag"]);
        this.httpClient = httpClient;
        this.models$ = new rxjs__WEBPACK_IMPORTED_MODULE_4__["BehaviorSubject"]([]);
        this.pull();
    }
};
...
let UsersService = class UsersService extends _crud__WEBPACK_IMPORTED_MODULE_6__["CRUD"] {
    constructor(httpClient) {
        super(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/user`, httpClient, _models__WEBPACK_IMPORTED_MODULE_5__["User"]);
        this.httpClient = httpClient;
        this.models$ = new rxjs__WEBPACK_IMPORTED_MODULE_4__["BehaviorSubject"]([]);
        this.pull();
    }
...
/* harmony import */ var _tinymce_tinymce_angular__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @tinymce/tinymce-angular */ "./node_modules/@tinymce/tinymce-angular/fesm2015/tinymce-tinymce-angular.js");
...
let CreateComponent = class CreateComponent {
    constructor(auth, posts, tagsService, usersService, router, route) {
        this.auth = auth;
        this.posts = posts;
...
let EditComponent = class EditComponent {
    constructor(auth, posts, tagsService, usersService, route, router) {
        this.auth = auth;
        this.posts = posts;
        this.tagsService = tagsService;
        this.usersService = usersService;
    ...
    onDelete() {
        if (this.post.exists) {
            ...
            this.posts.delete(this.post.id).subscribe((res) => {
                if (res === true) {
    ...
    ngOnInit() {
        ...
        this.route.params
            ...
            if (!!params.id) {
                if (this.isPage()) {
                    this.posts.getPage(params.id).subscribe((post) => {
                        if (post.exists) {
                            this.post = post;
                            this.updatePostStatus();
                        }
                    ...
                    this.posts.get(params.id).subscribe((post) => {
                        if (post.exists) {
                            this.post = post;
                            this.updatePostStatus();
                        }
...
let EditorComponent = class EditorComponent {
    ...
    ngSelectTagCreator(input) {
        const tag = new _app_admin_models_tag__WEBPACK_IMPORTED_MODULE_5__["Tag"]();
        tag.name = input;
...
let SettingComponent = class SettingComponent {
    ...
    onSubmit() {
        if (this.form.valid) {
            ...
            this.http
                ...
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((res) => new _models__WEBPACK_IMPORTED_MODULE_6__["Setting"](res)))
                .subscribe((setting) => {
    ...
    ngOnInit() {
        this.http
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])((err) => err), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((res) => new _models__WEBPACK_IMPORTED_MODULE_6__["Setting"](res)))
            .subscribe((setting) => {
            this.setting = setting;
            this.form.patchValue(this.setting);
        });
...
let TagsComponent = class TagsComponent {
    constructor(tagsService, auth, fb) {
        this.tagsService = tagsService;
        this.auth = auth;
        this.fb = fb;
    ...
    create() {
        this.tagsService.create(this.form.value).subscribe((tag) => {
            this.tagsService.pushModel(tag);
            this.createTag = false;
        });
    }
...
let EditComponent = class EditComponent {
    constructor(users, route, router, auth) {
        this.users = users;
        this.route = route;
        this.router = router;
        this.auth = auth;
    ...
    ngOnInit() {
        this.route.params
            ...
            .subscribe((params) => {
            if (!!params.id) {
                if (this.auth.currentUserValue.isWriter() &&
                    +params.id !== this.auth.currentUserValue.id) {
                    this.router.navigate(["admin/user"]);
                }
                this.users.find(params.id).then((val) => {
                    this.user = val;
                }, () => {
                    this.router.navigate(["admin/user"]);
                });
