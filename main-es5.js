...
var HomeService = /** @class */ (function () {
    ...
    HomeService.prototype.indexPosts = function (page) {
        var params = {};
        params.page = page;
...
var AuthorComponent = /** @class */ (function () {
    function AuthorComponent(_route, _home) {
        this._route = _route;
        this._home = _home;
...
var EmailSubComponent = /** @class */ (function () {
    function EmailSubComponent() {
    }
    EmailSubComponent.prototype.ngOnInit = function () {
    };
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.fetchPosts = function () {
        var _this = this;
        this._home.indexPosts(this.page).subscribe(function (response) {
            _this.posts = response.data;
            _this.count = response.total;
            _this.page = response.current_page;
            _this.nextPageUrl = response.next_page_url;
        });
    };
    HomeComponent.prototype.onTableDataChange = function (event) {
        this.page = event;
        this.fetchPosts();
    };
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(_home) {
        this._home = _home;
    ...
    HeaderComponent.prototype.toggleTopNav = function () {
    ...
    HeaderComponent.prototype.autoSetTopNavVisibility = function (innerWidth) {
...
var PostComponent = /** @class */ (function () {
    function PostComponent(_route, _home, _highlight) {
        this._route = _route;
        this._home = _home;
    ...
    PostComponent.prototype.isPage = function () {
...
var TagComponent = /** @class */ (function () {
    function TagComponent(_route, _home) {
        this._route = _route;
        this._home = _home;
        this.destroyed$ = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
    }
...
var PopupMsgComponent = /** @class */ (function () {
    function PopupMsgComponent() {
    ...
    Object.defineProperty(PopupMsgComponent.prototype, "errors", {
        get: function () {
            return this._errors;
        },
        set: function (errors) {
    ...
    Object.defineProperty(PopupMsgComponent.prototype, "httpErrors", {
        set: function (err) {
            if (err && err instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpErrorResponse"]) {
                var errors = err.error.errors
                    ? Object.keys(err.error.errors).map(function (key) { return err.error.errors[key]; })
                    : [err.error.message];
                this._errors = errors;
            }
        },
    ...
    PopupMsgComponent.prototype.deleteError = function (e, key) {
        this.errors.splice(key, 1);
        if (!this.errors || this.errors.length === 0 || this.errors.length < 0) {
            this.noErrorsLeft.emit();
        }
    };
    PopupMsgComponent.prototype.deleteSuccessMsg = function (e, key) {
    ...
    PopupMsgComponent.prototype.ngOnInit = function () { };
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
var TogglerDirective = /** @class */ (function () {
    function TogglerDirective(elementRef) {
        this.elementRef = elementRef;
        this.visible = false;
        this.autoToggle = true;
    }
    TogglerDirective.prototype.onDocumentClick = function (e) {
        var clickedEl = e ? e.target : false;
        var directiveEl = this.elementRef ? this.elementRef.nativeElement : false;
    ...
    TogglerDirective.prototype.toggle = function () {
        this.visible = !this.visible;
    };
    TogglerDirective.ctorParameters = function () { return [
